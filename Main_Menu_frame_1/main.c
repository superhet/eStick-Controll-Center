...
int main( int argc, char *argv[])
{
  ...
  *new,*sep1,*sep2, *open,*save, *save_as,*export, *quit, *sep, *tog_stat, *tog_tool;
  ...
  /*Attach the text for the statusbar to the Menu Item*/
  g_object_set_data (G_OBJECT (pref_1), "menuhint",(gpointer) "Show the Preferences Tab");
  ...
  /*Attach the text for the statusbar to the Menu Item*/
  g_object_set_data (G_OBJECT (tog_stat), "menuhint",(gpointer) "Show/Hide the Statusbarbar");
...
void show_about(GtkWidget *widget, gpointer data)
{
  ...
  gtk_about_dialog_set_copyright(GTK_ABOUT_DIALOG(dialog),"(c) Jacob Osman,Alois Taranetz,Tibor Elias");
